...
export default function AboutMeSection() {
    return (
        <section id='about' className='py-4 md:py-8'>
            <Container className='text-black dark:text-white max-w-6xl flex flex-col items-center gap-6 md:gap-12'>
                ...
                <div className='flex flex-col md:flex-row gap-6'>
                    {/* left cont */}
                    <div className='flex flex-col gap-6 md:w-1/2 text-center items-center p-3'>
                        ...
                        <div className='flex gap-6 mt-4'>
                            <Link
                                href="#contact"
                                className="relative inline-block font-semibold text-white rounded-full border-2 border-blue-700 px-6 py-3 
             overflow-hidden transition-all duration-300 ease-in-out hover:bg-blue-700 hover:text-white hover:scale-105"
                    ...
                    {/* right cont */}
                    <div className='flex flex-col md:w-1/2 gap-6 text-center '>
                        <ul className="grid grid-cols-1  gap-4 text-gray-800 dark:text-gray-200 font-medium">
                            <li>
