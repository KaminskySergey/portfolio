    ...
    return (
        <div className='flex flex-col gap-7 animate-on-scroll opacity-0' data-anim="slide-left">
            ...
            <div className="mt-6 md:mt-12 flex flex-col items-center gap-4">
             ...
             hover:bg-gray-800"
                        >
                            <svg className="w-8 h-8 text-black dark:text-white group-hover:text-blue-500" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
             ...
             hover:bg-gray-800"
                        >
                            <svg className="w-8 h-8 text-black dark:text-white group-hover:text-blue-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
